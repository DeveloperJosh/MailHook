...
async def get_bot_help(bot: ModMail) -> discord.Embed:
    ...
    return embed.add_field(
        name="‎",
        value=f"[Invite Me](https://discord.com/oauth2/authorize?client_id={bot.user.id}&permissions=8&scope=bot%20applications.commands) | [Support Server](https://discord.gg/TeSHENet9M) | [Dashboard](https://mailhook.netlify.app)",
        inline=False
